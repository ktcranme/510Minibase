...
public class MapUtils {
	...
	/*
	 * This function compares two maps in a specified field of the map
	 * note: the first field is map_fld_no=0
	 */
	public static int CompareMapWithMap(Map m1, Map m2, int map_fld_no) throws IOException, UnknowAttrType, TupleUtilsException {
	 ...
	 * it utilizes CompareMapWithMap in each of the 4 fields
	 */
