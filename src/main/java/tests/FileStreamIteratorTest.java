...
class FileStreamIteratorDriver extends TestDriver implements GlobalConst {

    public FileStreamIteratorDriver() {
        super("filestreamiteratortest");
    }

    protected String testName() {
        return "File Stream Iterator";
    }
    ...
    protected boolean test1() {
        ...
        try {
            fs = new FileStreamIterator(f.openStream(), expr2);
        } catch (Exception e) {
            e.printStackTrace();
...
public class FileStreamIteratorTest {
    public static void main(String argv[]) {
        FileStreamIteratorDriver fs = new FileStreamIteratorDriver();
